...
class MyBoomSecureNaiveConfig extends Config(
  new boom.common.WithMarkFor("naive") ++
  new boom.common.WithDefense("DelayAll") ++
  new boom.common.MyBoomBaseConfig(1) ++
  new chipyard.config.AbstractConfig)

class MyBoomSecureAutoSandboxConfig extends Config(
  new boom.common.WithMarkFor("auto_sandbox") ++
  new boom.common.WithDefense("DelayAll") ++
  new boom.common.MyBoomBaseConfig(1) ++
  new chipyard.config.AbstractConfig)

class MyBoomSecureCelliftConfig extends Config(
  new boom.common.WithMarkFor("cellift") ++
  new boom.common.WithDefense("DelayAll") ++
  new boom.common.MyBoomBaseConfig(1) ++
  new chipyard.config.AbstractConfig)
