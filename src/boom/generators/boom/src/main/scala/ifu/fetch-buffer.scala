  ...
  with HasBoomFrontendParameters
{
  ...
  if (boomParams.markFor=="auto_sandbox") {
    iftConfig(this, "Naive, PerWord")  // 1-57
    iftConfig(io.enq.valid, "Refined")  // 1-78
    iftConfig(do_enq, "Refined")  // 1-79
    iftConfig(in_mask, "Refined")  // 1-79
    iftConfig(enq_idxs, "Refined")  // 1-79
  }
