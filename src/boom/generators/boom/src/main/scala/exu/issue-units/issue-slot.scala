  ...
  with IssueUnitConstants
{
  ...
  if (boomParams.markFor=="auto_sandbox") {
    iftConfig(this, "Naive, PerWord")  // 1-29
    iftConfig(p1_poisoned, "Refined")  // 1-40
    iftConfig(p2_poisoned, "Refined")  // 1-40
    iftConfig(state, "Refined")  // 1-40
    iftConfig(p1, "Refined")  // 1-40
    iftConfig(p2, "Refined")  // 1-40
    iftConfig(ppred, "Refined")  // 1-40
    iftConfig(io.ldspec_miss, "Refined")  // 1-71
    iftConfig(io.in_uop.valid, "Refined")  // 1-71
  }
