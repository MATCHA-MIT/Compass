...
case class RocketTileParams(
    override val markFor: String = "None",
...
class RocketTileModuleImp(outer: RocketTile) extends BaseTileModuleImp(outer)
  ...
  if (outer.tileParams.markFor=="naive") {
    circuitIFTConfig(this, "Naive, PerWord")
  }
  else if (outer.tileParams.markFor=="cellift") {
    circuitIFTConfig(this, "Refined, PerBit")
  }
  else if (outer.tileParams.markFor=="auto_sandbox") {
